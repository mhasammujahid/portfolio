...
export const EXPERIENCE: Experience[] = [
  {
    ...
    achievements: [
      "Architected and scaled a cloud-based Learning Management System (LMS) serving 50,000+ Daily Active Users with high availability and reliability.",
      "Modernized 10+ legacy PHP components to the MERN stack and developed 5+ core modules, dramatically improving system maintainability and extensibility.",
      "Boosted backend performance by 60% through Redis caching, advanced MongoDB query optimization, and architectural refactoring.",
      "Engineered high-impact integrations with AWS S3 for storage, Zoom for live sessions, and iThenticate for plagiarism detection.",
      "Orchestrated DevOps workflows with automated CI/CD pipelines via GitHub Actions, deploying resilient services on AWS EC2.",
      "Strengthened platform security with JWT-based multi-factor authentication and Socket.io for real-time secure communication.",
    ],
  },
];
